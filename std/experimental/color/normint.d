...
*/
module std.experimental.color.normint;

import std.traits : isIntegral, isSigned, isUnsigned, isFloatingPoint;
static import std.algorithm;

import std.experimental.color.conv : FloatTypeFor;
...
pure nothrow @nogc:
    ...
    NormalizedInt!I opBinary(string op)(NormalizedInt!I rh) const if(op == "~")
    {
        static assert(false, "'" ~ op ~ "' operator not supported by NormalizedInt");
    }
